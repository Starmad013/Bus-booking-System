...
title_project= Label(frame2,text="Online Bus Booking System",relief="ridge",bg="light blue",fg="red",font=('Poppins',42,'bold'),padx=50)
title_project.grid(row=0,column=3)

Label(frame2,text="Check Your Booking",bg="green",font=('Arial 15 bold')).grid(row=1,column=3)

Label(frame2,text="Enter Your Mobile No. :",font=('Arial 10 bold')).grid(row=2,column=2)

mobile_no=Entry(frame2)
mobile_no.grid(row=2,column=3)

Button(frame2,text="Check Booking",fg="green",font=('Arial 12 bold'),command=checkticket).grid(row=2,column=5)

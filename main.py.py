...
#name of student
name_student= Label(root,text="Student Name : Gaurav Jat ",fg="blue",font=('Poppins',15),pady=30)
name_student.pack()
#enrollment no.
enroll= Label(root,text="Enrollment No. : 221B162 ",fg="blue",pady=30,font=('Poppins',15))
enroll.pack()



#mobile number
mobile= Label(root,text="Mobile No. : 7440266105 ",fg="blue",pady=30,font=('Poppins',15))
mobile.pack()
